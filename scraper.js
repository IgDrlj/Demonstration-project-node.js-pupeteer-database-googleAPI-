...
async function scrapeProduct(currURL, currDealSelector, checkForm, csmName) {
    ...
    if(typeof codes[0]==='undefined'){
        ...
        insertCall.insertInDB(storeURLScrape, storeNameFinal, currDealSelector, codes[0], dateTime, csmName);
