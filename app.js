...
var checkCSMs = require('./checkCSMData.js');
...
app.post('/postInsertData', (req, res) => {
    ...
    var csm = (req.body.csmNameInput);
    console.log(csm);
    scrapeIt.scrapeProduct(storeURL, dealSelector, '', csm);
...
app.post('/checkCSMData', (req, res) => {
    var selectedTrue = (req.body.csmNameCheck);
    console.log(selectedTrue);
    checkCSMs.checkCSMBase(selectedTrue);
    res.end('Checking selected store...')
});
